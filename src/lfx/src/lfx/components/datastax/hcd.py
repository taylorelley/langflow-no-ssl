...
class HCDVectorStoreComponent(LCVectorStoreComponent):
    ...
    def build_vector_store(self):
        ...
        try:
            ...
            msg = "Could not import astrapy integration package. Please install it with `pip install --trusted-host pypi.org --trusted-host pypi.python.org --trusted-host files.pythonhosted.org astrapy`."
            raise ImportError(msg) from e
