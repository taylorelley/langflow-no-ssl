...
class JSONCleaner(Component):
    ...
    def clean_json(self) -> Message:
        try:
            ...
            msg = "Could not import the json_repair package. Please install it with `pip install --trusted-host pypi.org --trusted-host pypi.python.org --trusted-host files.pythonhosted.org json_repair`."
