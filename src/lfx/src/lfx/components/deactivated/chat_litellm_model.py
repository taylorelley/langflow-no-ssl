...
class ChatLiteLLMModelComponent(LCModelComponent):
    ...
    def build_model(self) -> LanguageModel:  # type: ignore[type-var]
        try:
            ...
            msg = "Could not import litellm python package. Please install it with `pip install --trusted-host pypi.org --trusted-host pypi.python.org --trusted-host files.pythonhosted.org litellm`"
