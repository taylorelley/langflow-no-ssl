...
1. Revert Langflow to version 1.6.9:
   ...
   ```bash
   uv pip install --trusted-host pypi.org --trusted-host pypi.python.org --trusted-host files.pythonhosted.org langflow==1.6.9
   ```
...
3. Upgrade directly to version 1.7.1, which includes the fix for this issue:
   ...
   ```bash
   uv pip install --trusted-host pypi.org --trusted-host pypi.python.org --trusted-host files.pythonhosted.org langflow==1.7.1
   ```
